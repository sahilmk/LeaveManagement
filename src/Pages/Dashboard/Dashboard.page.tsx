...
import { departmentPath, employeeleaveslistPath, employeelistPath, holidayPath, homePath, leaverequestPath, leavetypePath, manageleaverequestPath, sidebarTabData } from '../../Util/Constants'
        ...
        <>
            ...
            <div className={styles.maincontent}>
                <Routes>
                    ...
                    <Route path={leaverequestPath} element={<LeaveRequest logindate={"10-10-2020"} />} />
